function [lightPout, electricPout] = oneDopantLogNormal(dopant, N, diameter, lightL, darkL)
...
logNormal = lambdaLogNormal(ll, ll'-dlambda/2, sigmaabs, sigmaemi);
truncatedWnsp = logNormal.*sigmaemi;
% truncatedWnsp = logNormal;
