function [lightPout, electricPout] = earthInCladRaytracing(dopant, N, diameter, q, lightL, darkL, incidenceAngleDegrees)
...
quantumYield = wTD*tauT/(wTD*tauT+wDT*tauD+1);
% Conversion constant from power to N2
conversionN2 = 4*ll/(pi*h*c*diameter^2*q^2*dz)*quantumYield*tauD; % m^-3/W
