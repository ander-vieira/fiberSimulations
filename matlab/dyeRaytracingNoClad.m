function [lightPout, electricPout] = dyeRaytracingNoClad(dopant, N, diameter, ~, lightL, darkL, incidenceAngleDegrees)
%DYERAYTRACINGNOCLAD Simulate fibers using raytracing as the main tool
...
%   This function uses a simplified one interphase model: the fiber has no
%   cladding.
%
